"""
Inference module — loads the merged LoRA adapter and runs generation.

The model cache is invalidated every round by phase4.py after training,
so /predict always uses the freshest aggregated weights.
"""
